<?php
    ...
    $allScenarios = getBmsScenario($_SESSION['behamad_uuid'],$_SESSION['behamad_token']);
        ...
        <div class="content">
            ...
            <div class="container pt-4 px-4">
                <div class="row bg-dark rounded align-items-start justify-content-start" id="buildingList">
                    ...
                    ?>
                        <div class="bg-secondary d-flex align-items-center border-bottom py-3">
                                    <div class="w-100 ms-3">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h6 class="mb-0 scenario-name"><?= substr($scenario->name,0,strpos($scenario->name,"-")) ?></h6>
                                        </div>
                                        <span><?= substr($scenario -> name,strpos($scenario->name,"-")+1,strlen($scenario -> name)-1) ?></span>
                                    </div>
                        </div>
                    <?php endforeach ?>
                </div>
