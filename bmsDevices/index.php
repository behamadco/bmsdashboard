<?php
    ...
    $allBmsDevices = getBmsDevices($_SESSION['behamad_uuid'],$_SESSION['behamad_token']);
...
<html dir="rtl" lang="fa">
    <head>
        <meta charset="utf-8">
        <title>دستگاه های ساختمان هوشمند - سیستم مدیریت ساختمان هوشمند بهامد</title>
        ...
        <div class="content">
            ...
            <div class="container pt-4 px-4">
                <div class="row bg-dark rounded align-items-start justify-content-start">
                    <?php
                        foreach($allBmsDevices -> data as $device):
                    ?>
                    <div class="col-sm-3 col-xl-3 section">
                        <a href="/dashboard/bms/devices/device/<?= $device -> devEui ?>">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                <img class="device-icon" src="/img/modem.png" alt="">
                                <div class="ms-3">
