<?php
    ...
    // $placeId = end($path);
    // $allDevices = getPlaceDevices($placeId,$_SESSION['behamad_uuid'],$_SESSION['behamad_token']);
...
<html dir="rtl" lang="fa">
    <head>
        <meta charset="utf-8">
        <title>دستگاه ها - سیستم مدیریت ساختمان بهامد</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/dashboard/charts" class="nav-item nav-link active"><i class="fa fa-clock me-2"></i>هتل هوشمند</a>
                </div>
            </nav>
        </div>
                    ...
                    <div class="col-sm-3 col-xl-3 section">
                        <a href="">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                <img class="device-icon" src="/img/beds.png" alt="">
                                <div class="ms-3">
                    ...
                    <div id="scenarioContent" class="modal">
                            <div class="modal-content">
                                ...
                                <div class="modal-item">
                                    <span><p> شماره اتاق: </p></span><span><p id="scenarioSourceDevice">201</p></span>
                                </div>
                                <div class="modal-item">
                                    <span><p> شماره طبقه: </p></span><span><p id="scenarioDestinationDevice">دوم</p></span>
                                </div>
                                <div class="modal-item">
                                    <span><p> شماره کارت: </p></span><span><p id="scenarioDestinationDevice">D01F3B21</p></span>
                                </div>
                                <div class="modal-item">
                                    <span><p>وضعیت: </p></span><span><p id="scenarioStatus"></p></span>
                                </div>
                                <button class="btn btn-block btn-info">حذف اتاق</button>
                            </div>
                        </div>
