...
<html dir="rtl" lang="fa">
    <head>
        <meta charset="utf-8">
        <title>سناریو ها - سیستم مدیریت ساختمان بهامد</title>
            ...
            <div class="container pt-4 px-4">
                <div class="row bg-dark rounded align-items-start justify-content-center" id="buildingList">
                    <div class="col-sm-3 col-xl-3 section">
                        <a href="/dashboard/scenario/smartHomeScenario">
                            <div class="bg-secondary rounded d-flex-column align-items-center justify-content-center p-4" style="text-align:center">
                                <img class="device-icon" src="/img/cpu.png" alt="">
                                <div class="ms-3">
                                    <h6 class="mb-0" style="padding-top:5%">سناریو های خانه هوشمند</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 col-xl-3 section">
                        <a href="/dashboard/scenario/bmsScenario">
                            <div class="bg-secondary rounded d-flex-column align-items-center justify-content-center p-4" style="text-align:center">
                                <img class="device-icon" src="/img/scenario.png" alt="">
                                <div class="ms-3">
                                    <h6 class="mb-0" style="padding-top:5%">سناریو های ساختمان هوشمند</h6>
                                </div>
                            </div>
                        </a>
                    </div>
